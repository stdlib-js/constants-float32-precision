...
```javascript
import FLOAT32_PRECISION from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-precision@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-precision/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/constants-float32-precision/actions/workflows/test.yml?query=branch:v0.2.1
